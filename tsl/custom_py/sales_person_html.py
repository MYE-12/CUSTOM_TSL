    ...
    for i in sp:
        ...
        # if i.name == "Ahmad" or i.name == "Vazeem" or i.name == "Maaz" or i.name == "Nidhin" or i.name == "EHAB" or i.name == "Mr. Yousef" or i.name == "Mohannad" or i.name == "Karoline" or i.name == "Ahmed Yahia":                              
            ...
            for index, m in enumerate(last_six_months):
                ...
                year = 2024
                if month_number == 1 or month_number == 2 or month_number == 3 or month_number == 4 or month_number == 5 or month_number == 6  or month_number == 8:
                    year = 2025
                ...
                q_m_2 = 0
                if wod:
                    if month_number >= 3 and company == "TSL COMPANY - UAE" and year == 2025:
                        for i in wod:
