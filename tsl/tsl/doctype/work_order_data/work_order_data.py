...
def create_evaluation_report(doc_no):
    ...
    if doc.branch == "Jeddah - TSL-SA":
        new_doc.naming_series = "EVAL-J-.YY.-"
    if doc.branch == "Riyadh - TSL- KSA":
        new_doc.naming_series = "EVAL-R-.YY.-"
...
def create_test_evaluation_report(doc_no):
        ...
        if doc.company == "TSL COMPANY - KSA":
            new_doc.branch = doc.branch
        if doc.branch == "Dammam - TSL-SA":
            new_doc.naming_series = "TEVAL-DMM-.YYYY.-"
        if doc.branch == "Jeddah - TSL-SA":
            new_doc.naming_series = "TEVAL-JED-.YYYY.-"
        if doc.branch == "Riyadh - TSL- KSA":
            new_doc.naming_series = "TEVAL-RIYADH-.YYYY.-"
...
def create_initial_eval(doc_no):
    ...
    new_doc.comment = doc.comment
    new_doc.status = doc.status_repair
    new_doc.branch = doc.branch
    if doc.company == "TSL COMPANY - KSA":
        new_doc.branch = doc.branch
    if doc.branch == "Dammam - TSL-SA":
...
def create_rn(wod):
    ...
    if doc.company == "TSL COMPANY - KSA":
        ...
        if doc.branch == "Dammam - TSL-SA":
            new_doc.naming_series = "RE-D.YY.-"
        if doc.branch == "Riyadh - TSL- KSA":
            new_doc.naming_series = "RE-R.YY.-"
    if doc.company == "TSL COMPANY - UAE":
        new_doc.naming_series = "RE-DU.YY.-"
    if doc.company == "TSL COMPANY - Kuwait":
        new_doc.naming_series = "RE-K.YY.-"
    new_doc.department = doc.department
...
def create_dn(wod):
    ...
    # if doc.branch == "Riyadh - TSL- KSA":
    #     new_doc.naming_series == "DN-R.YY.-"
    
    # if doc.branch == "Jeddah - TSL-SA":
    #     new_doc.naming_series == "DN-J.YY.-"

    # if doc.branch == "Dammam - TSL-SA":
    #     new_doc.naming_series == "DN-D.YY.-"
